...
<div>
    <Header />
    <div class="margin-top-10r" id="modalEditMessage" tabindex="-1" aria-labelledby="modalEditMessage" aria-hidden="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <form enctype="multipart/form-data">
                    <div class="modal-header d-flex flex-column flex-md-row align-items-center justify-content-start">
                        <p class="modal-title h5 mr-1">Editer mon message</p>
                    ...
                    <div class="modal-footer">
                        <div class="row w-100 justify-content-spacebetween">
                            <div class="col-6"><a @click="$bvModal.hide('modalEditMessage')" href="/home" class="btn text-light btn-secondary btn-block">Annuler</a></div>
                            <div class="col-6"><button type="submit" @click.prevent="updateMessage()" class="btn text-light btn-danger btn-block">Valider</button></div>
                        </div>
                    </div>
                </form>
            </div>
