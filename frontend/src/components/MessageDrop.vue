...
<div>
    <Header />
    <div class="margin-top-10r" id="modalDropMessage" tabindex="-1" aria-labelledby="modalDropMessage" aria-hidden="false">
                ...
                <form enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <div class="row w-100 justify-content-spacebetween">
                            <div class="col-6"><a href="/home" class="btn text-light btn-secondary btn-block">Annuler</a></div>
                            <div class="col-6"><button type="submit" @click.prevent="deleteMessage()" class="btn text-light btn-danger btn-block">Valider</button></div>
                        </div>
                    </div>
                </form>
            </div>
